...
describe('ObjectValidator', function() {
  try {
    fs.unlinkSync(`${__dirname}/optimized.js`)
  } catch (e) {}
  let validatorOptions = [{}, { optimize: true, cacheFile: `${__dirname}/optimized.js` }]
  for (let options of validatorOptions) {
    describe(`options: ${JSON.stringify(options)}`, function() {
      before(function() {
